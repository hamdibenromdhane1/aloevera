...
class XT_Woo_Variation_Swatches_Migration {

 	/**
	 * The single instance of XT_Woo_Variation_Swatches_Migration.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	/**
	 * XT_Woo_Variation_Swatches_Migration Instance
	 *
	 * Ensures only one instance of XT_Woo_Variation_Swatches_Migration is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see Slick_Menu()
	 * @return XT_Woo_Variation_Swatches_Migration instance
	 */
