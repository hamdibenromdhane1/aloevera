 ...
 */
class XT_Woo_Variation_Swatches
{
    /**
     ...
     * @since    1.0.0
     * @access   protected
     * @var      XT_Woo_Variation_Swatches_Loader    $loader    Maintains and registers all hooks for the plugin.
     */
    protected  $loader ;
    /**
     ...
     *
     * - XT_Woo_Variation_Swatches_Loader. Orchestrates the hooks of the plugin.
     * - XT_Woo_Variation_Swatches_i18n. Defines internationalization functionality.
     * - XT_Woo_Variation_Swatches_Admin. Defines all hooks for the admin area.
     * - XT_Woo_Variation_Swatches_Public. Defines all hooks for the public side of the site.
     *
    ...
    private function load_dependencies()
    {
         ...
         * Woocommerce hooks.
         */
        require_once $this->plugin_path() . 'includes/woocommerce.php';
        /**
         * The class responsible for defining all actions that occur in the admin area.
         */
        require_once $this->plugin_path() . 'admin/class-admin-base.php';
        require_once $this->plugin_path() . 'admin/class-admin.php';
        require_once $this->plugin_path() . 'admin/class-product-swatches-tab.php';
        /**
         * The class responsible for defining all actions that occur in the public-facing
         * side of the site.
         */
        require_once $this->plugin_path() . 'public/class-public.php';
        return new XT_Woo_Variation_Swatches_Loader();
    }
    
    /**
     * Define the locale for this plugin for internationalization.
     *
     * Uses the XT_Woo_Variation_Swatches_i18n class in order to set the domain and to register the hook
     * with WordPress.
     *
     * @since    1.0.0
     * @access   private
    ...
    {
        $plugin_i18n = new XT_Woo_Variation_Swatches_i18n();
    ...
    private function define_admin_hooks()
    {
        ...
        if ( is_admin() ) {
            ...
            new XT_Woo_Variation_Swatches_Migration( $this );
        }
        $this->plugin_admin = new XT_Woo_Variation_Swatches_Admin( $this );
        ...
        $this->loader->add_action(
            'admin_init',
            $this->plugin_admin,
            'init_attribute_hooks',
            1
        );
        $this->loader->add_action(
            'woocommerce_product_option_terms',
            $this->plugin_admin,
            'product_option_terms',
            10,
            2
        );
        $this->loader->add_action(
        ...
        $this->loader->add_filter( 'product_attributes_type_selector', $this->plugin_admin, 'add_attribute_types' );
        $this->plugin_swatches_tab = new XT_Woo_Variation_Swatches_Tab( $this );
        $this->loader->add_filter(
            'woocommerce_product_data_tabs',
            $this->plugin_swatches_tab,
            'product_swatches_data_tab',
            99,
            1
        );
        $this->loader->add_action( 'woocommerce_product_data_panels', $this->plugin_swatches_tab, 'product_data_panel_wrap' );
        $this->loader->add_action(
        ...
        $this->loader->add_action( 'admin_enqueue_scripts', $this->plugin_swatches_tab, 'enqueue_scripts' );
        $this->loader->add_action( 'wp_ajax_xt_woovs_admin_tab_content', $this->plugin_swatches_tab, 'load_tab_content_ajax' );
        $this->loader->add_action( 'save_post', $this->plugin_swatches_tab, 'save_post_ajax' );
        $this->loader->add_action( 'admin_head-post.php', $this->plugin_swatches_tab, 'enqueue_product_ajax_save_script' );
        $this->loader->add_action( 'admin_head-post-new.php', $this->plugin_swatches_tab, 'enqueue_product_ajax_save_script' );
    }
    ...
    {
        $this->plugin_public = new XT_Woo_Variation_Swatches_Public( $this );
        $this->loader->add_action( 'wp_enqueue_scripts', $this->plugin_public, 'enqueue_styles' );
        $this->loader->add_action( 'wp_enqueue_scripts', $this->plugin_public, 'enqueue_scripts' );
        $this->loader->add_filter( 'body_class', $this->plugin_public, 'body_class' );
        $this->loader->add_filter( 'post_class', $this->plugin_public, 'product_post_class' );
        $this->loader->add_filter(
    ...
    {
        new XT_Woo_Variation_Swatches_Customizer( $this );
    }
    
    public function customizer_controls( $wp_customize )
    {
        require_once $this->plugin_path() . 'includes/customizer/class-customizer-controls.php';
        new XT_Woo_Variation_Swatches_Customizer_Controls( $wp_customize );
    }
    ...
    {
        return apply_filters( 'xt_woo_variation_swatches_template_path', 'woo-variation-swatches/' );
    }
     ...
     *
     * @since     1.0.0
     * @return    XT_Woo_Variation_Swatches_Loader    Orchestrates the hooks of the plugin.
     */
     ...
     *
     * @since     1.0.0
     * @return    XT_Woo_Variation_Swatches_Public    Frontend side of the plugin.
     */
     ...
     *
     * @since     1.0.0
     * @return    XT_Woo_Variation_Swatches_Admin    Backend side of the plugin.
     */
    ...
    {
        _doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'xt-woo-variation-swatches' ), $this->plugin_version() );
    }
